...
'steamcf_api_bad_response' => "Bad response from Steam",
'steamcf_library_missing' => "Your PHP installation is missing library '%s'",
'steamcf_validation_error' => "Steam ID is invalid: '%s'",
